...
@interface PromptlyViewController ()<UITextFieldDelegate,UIAlertViewDelegate>
{
    NSTimer            *_timer;
    int                _times;
}
...
@implementation PromptlyViewController
...
- (void)viewDidLoad
{
    ...
    DebugLog(@"%@",self.navigationController.navigationBar);
